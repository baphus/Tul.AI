...
export const homeTranslations: Record<Language, HomeCopy> = {
  ...
  BIS: {
    heroTitle: "Mas duol ang imong sunod nga oportunidad kaysa sa imong hunahuna.",
    heroBody: "Makapabug-at ang pagpangita og suporta sa eskuylahan. Tabangan ka sa Tul.AI sa pagsusi og oportunidad nga mas klaro, hinay-hinay.",
    heroCta: "Pangitaa ang akong mga scholarship",
    heroImageAlt: "Upat ka estudyante nga naglakaw sa agianan sa campus ug nagtan-aw sa telepono.",
    statsTitle: "Angay ka og mas klarong dalan paingon sa unahan.",
    stats: ["Susihon ang mga scholarship nga mahimong angay sa imong dalan.", "Sabta ang matag oportunidad sa klaro ug sayon nga pinulongan.", "Adto sa opisyal nga pahina sa provider kung andam na ka mo-apply."],
    sourcesTitle: "Mga scholarship alang sa mga estudyanteng Pilipino bisan asa",
    sources: [
      { label: "Gobyerno", title: "Publikong suporta nga gipatik", body: "Mga scholarship gikan sa nasudnong ahensiya ug lokal nga gobyerno, uban sa opisyal nga pahibalo.", explore: "Susihon ang scholarship sa gobyerno", imageAlt: "Makasaysayanong publikong bilding sa Maynila" },
    ...
    supportItems: [
      { title: "Pangitaa ang angay sa imong dalan", body: "Sugdi sa imong nahibaw-an bahin sa imong kaugalingon, pagtuon, ug suporta nga imong gipangita." },
      { title: "Sabta ngano nga nigawas ang matag usa", body: "Tan-awa ang gipatik nga kinahanglanon, unsay makumpirma sa imong profile, ug unsa pay angay susihon." },
      { title: "Iduol ang opisyal nga impormasyon", body: "Basaha ang tinubdan ug kahimtang sa pagpamatuod sa dili pa saligan." },
      { title: "Padayon sa imong kaugalingong dagan", body: "I-save ang oportunidad aron balikan ug adto sa opisyal nga pahina sa provider kon andam na ka." },
    ],
    supportCta: "Sugdi dinhi",
    coverageTitle: "Matag institusyong among sakop ug unsay ilang gipatik.",
    coverageBody: (count) => `Tanang ${count} ka rekord nga among gikuptan karon—dili kini sample sa mas dako nga indeks. Cebu-first ang coverage samtang gipamatud-an namo ang kalidad sa matag rekord.`,
    coverageCta: "Ablihi ang tibuok direktoryo",
    closeTitle: "Pangitaa ang mga scholarship nga mahimo nimong sundon.",
    closeBody: "Tubaga ang lima ka pangutana. Tan-awa ang napamatud-ang oportunidad uban sa gipatik nga kinahanglanon sa matag match.",
    closeCta: "Pangitaa ang akong mga scholarship",
    tierSource: (tier) => `Tier ${tier} nga tinubdan`,
  },
};
